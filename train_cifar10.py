...
train_dataset = CIFAR10(
    ...
    None,
    root=os.path.join("data", "CIFAR-10"),
    download=True,
    train=True,
    ...
    for step, batch in enumerate(tqdm(dataloader)):
        ...
        if step % update_interval == 0 and step > 0:
            ...
            print(
                ...
                "accuracy: %.2f (last), %.2f (average), %.2f"
                " (best)\n"
                % (
            ...
            if accuracy["all"][-1] > best_accuracy:
                ...
                with open(
                    os.path.join(
                        ...
                        "results",
                        "parameters",
                        "assignments_cifar10_best.pickle"), 'wb') as fp:
                ...
                with open(
                    os.path.join(
                        ...
                        "results",
                        "parameters",
                        "proportions_cifar10_best.pickle"), 'wb') as fp:
            ...
            with open(
                os.path.join(
                    ...
                    "results",
                    "parameters",
                    "assignments_cifar10.pickle"), 'wb') as fp:
            ...
            with open(
                os.path.join(
                    ...
                    "results",
                    "parameters",
                    "proportions_cifar10.pickle"), 'wb') as fp:
        ...
        while spikes['Ae'].get('s').sum() < 5 and retries < 3:
            ...
            inputs = {'X': sample.view(int(time/dt), 1, 1, 32, 32)}
            network.run(inputs=inputs, time=time,  input_time_dim=1)
